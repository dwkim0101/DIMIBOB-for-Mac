...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "Dimibob", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        if failError == nil {
            ...
            let url = self.applicationDocumentsDirectory.appendingPathComponent("Dimibob.storedata")
            do {
