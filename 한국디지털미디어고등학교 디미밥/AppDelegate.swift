//
//  AppDelegate.swift
//  한국디지털미디어고등학교 디미밥
//
//  Created by 상훈 on 2017. 3. 14..
//  Copyright © 2017년 MR.LEE(leeshoon1344). All rights reserved.
//
...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "_____________________________________", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        if failError == nil {
            ...
            let url = self.applicationDocumentsDirectory.appendingPathComponent("_____________________________________.storedata")
            do {
